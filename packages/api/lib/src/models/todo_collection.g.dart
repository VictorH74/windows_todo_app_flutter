...
TodoCollection _$TodoCollectionFromJson(Map<String, dynamic> json) => TodoCollection(
...
Map<String, dynamic> _$TodoCollectionToJson(TodoCollection instance) => <String, dynamic>{
      'id': instance.id,
